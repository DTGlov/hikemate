...
/**
 * Pumps the current user's location into the crew channel, throttled to
 ...
 */
export function useCrewBroadcast(): void {
  ...
  // Reset throttling refs whenever the crew context changes so we don't
  // carry stale "last broadcast" timestamps between crews.
  useEffect(() => {
